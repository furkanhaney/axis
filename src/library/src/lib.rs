...
pub mod prelude {
    pub use crate::{
        ...
        Flatten, GELU, GroupNorm, Identity, IdentityScheme, Idr, IdrLimits, IdrReceipt,
        ...
        LearningProgressReceipt, Linear, LocalResponseNorm, Lstm, LstmCell, LstmRun, LstmState,
        MaxPool2d, MaxPool3d, Module, ModuleDict, ModuleList, MonotoneDirection,
        MonotonicityLimits, Muon, MuonMatrix, MuonMatrixOrientation, MuonWithAuxAdamW, Optimizer,
        ParamId, Parameter, ParameterDict, ParameterList, PopulationLinear, PopulationMode,
        ...
        Trainer, Unflatten, clip_grad_norm, cosine_annealing_lr, one_cycle_lr,
    };
}

...
pub mod prelude {
    pub use crate::{
        ...
        GELU, GLU, GroupNorm, IdentityScheme, Idr, IdrLimits, IdrReceipt, InMemoryDataset,
        ...
        ResidualEvidence, ResidualLimits, ResidualScope, Result, RmsNorm, SELU, SGD, Sample,
